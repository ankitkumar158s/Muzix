...
public class BookmarkController {
	...
	@GetMapping("getbookmarks/{singerName}")
	public ResponseEntity<Bookmark> getBookmarkBysingerName(@PathVariable String singerName) {
		Bookmark bookmark = this.bookmarkService.getBookmarkBysingerName(singerName);
		if(bookmark!= null) {
			return new ResponseEntity<Bookmark>(bookmark,HttpStatus.OK);
		}
		else
